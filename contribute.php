...
$query4 = "insert into contributions values (\"$username\",\"$mobile\",\"$city\",\"$description\",\"$github\",\"$linkedin\",\"$email\",\"$profession\");";
...
<footer class="text-center text-white bg-dark">
    <div class="bg-dark">
        ...
        <div class="container p-4 pb-0">
            ...
            <section class="mb-4">
                <!-- Facebook -->
                <a class="btn btn-light btn-floating m-1" href="https://www.facebook.com/klakshmi.suryateja"
                    target="_blank" role="button" title="Facebook"><img src="./assets/facebook.svg"></a>

                <!-- Twitter -->
                <a class="btn btn-light btn-floating m-1" href="https://twitter.com/klsteja" role="button"
                    target="_blank" title="Twitter"><img src="./assets/twitter.svg"></a>

                <!-- Google -->
                <a class="btn btn-light btn-floating m-1" href="https://wa.me/916309639490" role="button"
                    target="_blank" title="WhatsApp"><img src="./assets/whatsapp.svg"></a>

                <!-- Instagram -->
                <a class="btn btn-light btn-floating m-1" href="https://www.instagram.com/nombre_es_surya/"
                    target="_blank" role="button" title="Instagram"><img src="./assets/instagram.svg"></a>

                <!-- Linkedin -->
                <a class="btn btn-light btn-floating m-1"
                    href="https://www.linkedin.com/in/k-lakshmi-surya-teja-8b0124247/" target="_blank" role="button"
                    title="LinkedIn"><img src="./assets/linkedin.svg"></a>

                <!-- Github -->
                <a class="btn btn-light btn-floating m-1" href="https://github.com/k-surya-teja" role="button"
